...
/**
 * Carrier [AbstractRefactoring] for the Kotlin **Introduce Functional Parameter** refactoring
 * (E9.14).
 *
 * After the UI dialog is confirmed, [request] holds the user-edited name/checkboxes to apply.
 * Set by `KotlinIntroduceFunctionalParameterUI.setParameters()`.
 *
 ...
 */
class KotlinIntroduceFunctionalParameterRefactoring(
    ...
    var request: KaIntroduceFunctionalParameterRequest? = null
}
